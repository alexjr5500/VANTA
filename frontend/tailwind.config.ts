  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        vanta: {
          black: "var(--vanta-black)",
          obsidian: "var(--vanta-obsidian)",
          panel: "var(--vanta-panel)",
          surface: "var(--vanta-surface)",
          elevated: "var(--vanta-elevated)",
          graphite: "var(--vanta-graphite)",
          gray: "var(--vanta-gray)",
          "gray-light": "var(--vanta-gray-light)",
          silver: "var(--vanta-silver)",
          "silver-bright": "var(--vanta-silver-bright)",
          white: "var(--vanta-white)",
          "pure-white": "var(--vanta-pure-white)",
          gold: "var(--vanta-gold)",
          "gold-bright": "var(--vanta-gold-bright)",
          "gold-deep": "var(--vanta-gold-deep)",
        },
        gold: {
          DEFAULT: "var(--vanta-gold)",
          bright: "var(--vanta-gold-bright)",
          deep: "var(--vanta-gold-deep)",
        },
        glass: {
